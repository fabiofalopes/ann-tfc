#!/usr/bin/env python3
"""
Script to generate Postman collection from OpenAPI JSON file
"""
import json
...
def generate_postman_collection():
    ...
    try:
        with open('annotation_api_openapi.json', 'r') as f:
            openapi_spec = json.load(f)
    except FileNotFoundError:
        print("Error: annotation_api_openapi.json not found")
        return None
...
if __name__ == "__main__":
    print("Generating Postman collection from OpenAPI JSON...")
    ...
    if collection:
        ...
        print("5. Set the 'baseUrl' variable if needed (default: http://localhost:8000)")
