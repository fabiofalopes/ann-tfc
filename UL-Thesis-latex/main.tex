...
\begin{document}
    ...
    \input{chapters/pertinencia-e-viabilidade}
    \input{chapters/especificacao-e-modelacao}
    \input{chapters/solucao-proposta}
    \input{chapters/testes-e-validacao}
    \input{chapters/metodo-e-planeamento}
